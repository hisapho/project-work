...
(function($){
    ...
    function change(show, hide){
        ...
        if(opts.dir == 'x'){
            ...
            $(this).find('.slide-wrapper').stop().animate({'margin-left':-x}, function(){opts['isAnimate'] = false;});
            opts['isAnimate'] = true
        }else{
            $(this).find('.slide-wrapper li').eq(hide).stop().animate({opacity:0});
            $(this).find('.slide-wrapper li').eq(show).show().css({opacity:0}).stop().animate({opacity:1});
        }
